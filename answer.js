...
function Game() {
  ...
  this.inputs = [
    new input("1. ", "de_forest", 200-64, 120 - 20 * 2, 16), // De_Forest
    new input("2. ", "c02footprint", 200-64, 120 - 20 * 1, 16), // C02FOOTPRINT
    new input("3. ", "robert bilott", 200-64, 120, 16), // Robert Bilott
    new input("4. ", "oceana", 200-64, 120 + 20 * 1, 16) // Oceana
  ]
...
function input(prompt, answer, x, y, dw) {
  ...
  this.draw = () => {
    this.correct = this.input.value().toLowerCase() == answer;
